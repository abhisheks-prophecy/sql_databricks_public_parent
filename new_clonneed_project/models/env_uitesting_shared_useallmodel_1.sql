...
Join_1 AS (
  ...
  INNER JOIN all_type_parquet_1_1_1 AS in1
...
Subgraph_10 AS (
  ...
  WITH Limit_7 AS (
    ...
    FROM all_type_parquet_1_1 AS env_uitesting_main_model_databricks_1
  ...
  complex_joined_data AS (
  
    {#Combines and filters data from multiple sources to create a comprehensive view of related information.#}
    SELECT 
      in1.c_int AS p_int,
      in1.c_string AS p_string,
    ...
    LEFT JOIN Subgraph_8 AS in2
       ON in1.c_string != in2.sm_type
    RIGHT JOIN OrderBy_2_1 AS in3
       ON in2.sm_type != in3.c_string
